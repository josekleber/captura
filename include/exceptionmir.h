...
enum MIR_EXCEPTION
{
    ...
    MIR_ERR_FRAME_ALLOC             = -12012,
    MIR_ERR_ENCONDING               = -12013,
    MIR_ERR_WRITE_FRAME             = -12014,
    MIR_ERR_OPEN_OUTPUT_FILE        = -12015,
    MIR_ERR_OPEN_FORMAT_CONTEXT     = -12016,
    MIR_ERR_OPEN_OUTPUT_FORMAT      = -12017,
    MIR_ERR_OPEN_CODEC_CONTEXT      = -12018,
    MIR_ERR_INIT_SWR_CONTEXT        = -12019,
    MIR_ERR_BUFFER_ALLOC            = -12020,
    MIR_ERR_RESAMPLE                = -12021,
    MIR_ERR_ENCODE                  = -12022,
    MIR_ERR_RAW_VECTOR_ALLOC        = -12023,
    MIR_ERR_CREATE_PATH             = -12024,
