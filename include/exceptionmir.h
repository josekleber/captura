...
{
    // CAPTURA
    MIR_ERR_STREAM_CONNECTION1      = -10001,
    MIR_ERR_STREAM_CONNECTION2      = -10002,
    MIR_ERR_BADALLOC_CONTEXT        = -10003,
    MIR_ERR_CONNECTION_CLOSED       = -10004,
    MIR_ERR_MEDIA_TYPE_NO_AUDIO     = -10005,
    ...
    MIR_ERR_OPEN_STREAM_1           = -12002,
    MIR_ERR_OPEN_STREAM_2           = -12003,
    MIR_ERR_OPEN_STREAM_3           = -12004,
    MIR_ERR_OUTPUT_FORMAT           = -12005,
    MIR_ERR_OPEN_CODEC              = -12006,
    MIR_ERR_ALLOC_SWR_CONTEXT       = -12007,
    MIR_ERR_INIT_INPUT_FRAME        = -12008,
    MIR_ERR_READ_INPUT_FRAME        = -12009,
    MIR_ERR_ALLOC_CONVERTED         = -12010,
    MIR_ERR_CONVERTER               = -12011,
    MIR_ERR_FRAME_ALLOC_1           = -12012,
    MIR_ERR_FRAME_ALLOC_2           = -12013,
    MIR_ERR_FRAME_ALLOC_3           = -12014,
    MIR_ERR_FRAME_ALLOC_4           = -12015,
    MIR_ERR_ENCONDING               = -12016,
    MIR_ERR_WRITE_FRAME             = -12017,
    MIR_ERR_OPEN_OUTPUT_FILE        = -12018,
    MIR_ERR_OPEN_FORMAT_CONTEXT     = -12019,
    MIR_ERR_OPEN_OUTPUT_FORMAT      = -12020,
    MIR_ERR_OPEN_CODEC_CONTEXT      = -12021,
    MIR_ERR_INIT_SWR_CONTEXT        = -12022,
    MIR_ERR_BUFFER_ALLOC_IN         = -12023,
    MIR_ERR_BUFFER_ALLOC_OUT        = -12024,
    MIR_ERR_BUFFER_ALLOC_NULL       = -12025,
    MIR_ERR_RESAMPLE                = -12026,
    MIR_ERR_ENCODE                  = -12027,
    MIR_ERR_RAW_VECTOR_ALLOC        = -12028,
    MIR_ERR_CREATE_PATH             = -12029,
