...
{
public:
    Database_SQL(std::string sqlConnect);
    ...
    */
    ...
    /** \brief
    * Insert o reconhecimento no banco de dados TEMP do SqlServer para o aprovador aprovar o reconhecimento no futuro.
    *
    * \param radio          - ID da radio que ocorreu o reonhcimento.
    * \param song           - ID da música reconhecida que é o resultado do MRServer.
    * \param datetime       - Use o getDateSqlString para pegar a data atual com o formato correto.
    * \param pathMp3        - Caminho do arquivo MP3.
    *
    * \exception
    */
    void insertRecognitionOccurrence(int radio, int song, string datetime, string pathMp3);
